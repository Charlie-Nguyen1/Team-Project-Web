...
const initialPatients = [
  { id: "01", name: "Boubacar Kande", dateOfBirth: "1998-05-15", lastVisit: "2023-11-20", procedure: "Prophylaxis (Cleaning)", phone: "647-001-3456" },
  { id: "02", name: "Ritesh Kumar", dateOfBirth: "1995-02-28", lastVisit: "2023-10-10", procedure: "Comprehensive Oral Exam", phone: "647-002-7890" },
  { id: "03", name: "Van Thanh Nguyen", dateOfBirth: "1990-09-01", lastVisit: "2024-01-15", procedure: "Restorative Filling", phone: "647-003-1234" },
  { id: "04", name: "Basil Peter Kunnath", dateOfBirth: "1982-12-05", lastVisit: "2023-12-03", procedure: "Endodontic Therapy", phone: "647-004-5678" },
  { id: "05", name: "Mohamad Ayan Saiyed", dateOfBirth: "2001-07-22", lastVisit: "2024-02-10", procedure: "Invisalign Treatment Review", phone: "647-005-9012" },
];
...
const DentalApp = () => {
  ...
  useEffect(() => {
    // nothing for now; keep dashboard metrics derived from state in render
  }, []);
              ...
              <div id="review-slider" className="h-96 overflow-y-scroll space-y-6 pr-4">
                <div className="border-b border-gray-100 pb-4">
                  <div className="flex items-center mb-2">
                    <img src="public/avatar/cat.png" className="w-10 h-10 rounded-full mr-3 border border-gray-200"
                      alt="User Avatar" />
                      <div>
                ...
                <div className="border-b border-gray-100 pb-4">
                  <div className="flex items-center mb-2">
                    <img src="public/avatar/meme.jpg" className="w-10 h-10 rounded-full mr-3 border border-gray-200"
                      alt="User Avatar" />
                      <div>
                ...
                <div className="border-b border-gray-100 pb-4">
                  <div className="flex items-center mb-2">
                    <img src="public/avatar/cute.jpg" className="w-10 h-10 rounded-full mr-3 border border-gray-200"
                      alt="User Avatar" />
                      <div>
                ...
                <div className="border-b border-gray-100 pb-4">
                  <div className="flex items-center mb-2">
                    <img src="public/public/avatar/gangsta.png" className="w-10 h-10 rounded-full mr-3 border border-gray-200"
                      alt="User Avatar" />
                      <div>
                ...
                <div className="border-b border-gray-100 pb-4">
                  <div className="flex items-center mb-2">
                    <img src="public/avatar/thug.jpg" className="w-10 h-10 rounded-full mr-3 border border-gray-200"
                      alt="User Avatar" />
                      <div>
                ...
                <div className="border-b border-gray-100 pb-4">
                  <div className="flex items-center mb-2">
                    <img src="public/avatar/joker.webp" className="w-10 h-10 rounded-full mr-3 border border-gray-200"
                      alt="User Avatar" />
                      <div>
                ...
                <div className="border-b border-gray-100 pb-4">
                  <div className="flex items-center mb-2">
                    <img src="public/avatar/spiderman.jpg" className="w-10 h-10 rounded-full mr-3 border border-gray-200"
                      alt="User Avatar" />
                      <div>
                ...
                <div className="pb-4">
                  <div className="flex items-center mb-2">
                    <img src="public/avatar/thanos.jpg" className="w-10 h-10 rounded-full mr-3 border border-gray-200"
                      alt="User Avatar" />
                      <div>
        ...
        <section id="patients-section" className="py-24">
          <div className="max-w-8xl mx-auto px-6 sm:px-8 lg:px-12">
            <div className="bg-card-bg p-10 rounded-xl shadow-medium border border-gray-100">
              <h2 className="text-3xl font-bold text-primary-dark mb-6 border-b pb-3">Patient Records (Read - R)</h2>
